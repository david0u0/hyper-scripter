function __hs_list_scripts
    set -l orig_cmd (commandline -j)
    set -l cmd (eval "command hs completion alias $orig_cmd" 2>/dev/null)
    if [ $status -ne 0 ]
        return
    end
    set -l list (eval "command hs completion ls $cmd" 2>/dev/null)
    if [ $status -ne 0 ]
        return
    end
    string split ' ' $list
...
complete -c hs -n "__fish_use_subcommand" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
complete -c hs -n "__fish_use_subcommand" -l recent -d 'Show scripts within recent days.'
complete -c hs -n "__fish_use_subcommand" -l dump-args
...
complete -c hs -n "__fish_use_subcommand" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from help" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from help" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from env-help" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from edit" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from edit" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from alias" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from alias" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from run" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from run" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from which" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from which" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from cat" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from cat" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from rm" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from rm" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from ls" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from ls" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from cp" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from cp" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from mv" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from mv" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from tags" -s u -l unset
complete -c hs -n "__fish_seen_subcommand_from tags" -s s -l switch-activated
complete -c hs -n "__fish_seen_subcommand_from tags" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
complete -c hs -n "__fish_seen_subcommand_from tags" -l recent -d 'Show scripts within recent days.'
complete -c hs -n "__fish_seen_subcommand_from tags" -s h -l help -d 'Prints help information'
...
complete -c hs -n "__fish_seen_subcommand_from tags" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from history" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from history" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from rm" -s a -l all -d 'Shorthand for `-f=all,^removed --timeless`'
complete -c hs -n "__fish_seen_subcommand_from rm" -l timeless -d 'Show scripts of all time.'
complete -c hs -n "__fish_seen_subcommand_from rm-id" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from rm-id" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from show" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from show" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from neglect" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from neglect" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from amend" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from amend" -l no-alias
...
complete -c hs -n "__fish_seen_subcommand_from tidy" -s f -l filter -d 'Filter by tags, e.g. `all,^mytag`'
...
complete -c hs -n "__fish_seen_subcommand_from tidy" -l no-alias
